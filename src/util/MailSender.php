...
function test()
{
    ...
    $sender->setReceiver("zhao0829wang@163.com");
    $sender->setCc("496307783@qq.com");
    $sender->setCc("418005442@qq.com");
    $sender->setMail("这是测试", "那就测试吧.你们收到了么？");
    $sender->sendMail();
}
...
//        echo $data;
    ...
    {
        $mail = new MailSender();
        $mail->setServer("smtp.qq.com", "1945190809@qq.com", "jmbvcjlrtbgmeegb", 465, true);
        $mail->setFrom("1945190809@qq.com");
        return $mail;
    }
}